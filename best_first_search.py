#if u want to run best first search uncomment below example and last output lines and run this file
...
# Best_first_Search Algorithm with h1
def best_first_search_h1(start_state,goal_state):
    ...
    queue.push([h1(start_state,goal_state),start_state,level,[[0]]])
        ...
        if(l[1]==goal_state):
            ...
            for i in a:
                if(0<=x+i and x+i<=2):
                    ...
                    temp=l[3]+[l[1]]
                    queue.push([h1(temp_start_state,goal_state),temp_start_state,temp_level+1,temp])
...
# best_first_Search Algorithm with h2
def best_first_search_h2(start_state,goal_state):
    start_time = time.time()
    a=[-1,1]
    b=[-1,1]
    test=1
    ...
    queue.push([h2(start_state,goal_state),start_state,level,[[0]]])
        ...
        if(l[1]==goal_state):
            ...
            for i in a:
                if(0<=x+i and x+i<=2):
                    ...
                    # temp to make list for optimal path
                    temp=l[3]+[l[1]]
                    queue.push([h2(temp_start_state,goal_state),temp_start_state,temp_level+1,temp])
...
# start_state=[[2,8,3],[1,6,4],[7,'B',5]]
# goal_state=[[1,2,3],[8,'B',4],[7,6,5]]


# print("\n\n\n******* Best First Search using using H1 *******")
# best_first_search_h1(copy.deepcopy(start_state),goal_state)
# print("\n\n\n******* Best First Search using using H2 *******")
# best_first_search_h2(copy.deepcopy(start_state),goal_state)
